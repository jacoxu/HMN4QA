...
idnumberlist_question_female.append('女士，请提供住客的身份证号码。')
idnumberlist_question_female.append('小姐，入住客人的身份证是？')
...
idnumberlist_question_male.append('先生，请提供住客的身份证号码。')
idnumberlist_question_male.append('先生，入住客人的身份证是？')
...
idnumberlist_question_unisex.append('请提供住客的身份证号码。')
idnumberlist_question_unisex.append('入住客人的身份证是？')
