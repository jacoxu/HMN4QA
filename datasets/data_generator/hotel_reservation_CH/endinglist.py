...
endinglist_server_female.append('女士，您所需要的房间已经预订成功。')
...
endinglist_server_female.append('可以了，房间为您预订成功，小姐。')
...
endinglist_server_male.append('先生，您所需要的房间已经预订成功。')
...
endinglist_server_male.append('可以了，房间为您预订成功，先生。')
...
endinglist_server_unisex.append('您所需要的房间已经预订成功。')
...
endinglist_server_unisex.append('可以了，房间为您预订成功。')
