...
namelist_question_female.append('住客姓名？')
...
namelist_question_unisex.append('请问您要入住宾馆的用户姓名是？')
...
namelist_question_unisex.append('请输入住客姓名。')
namelist_question_unisex.append('住客的名字是什么？')
namelist_question_unisex.append('住客怎么称呼？')
namelist_question_unisex.append('住客叫什么名字？')
namelist_question_unisex.append('住客的姓名是？')
...
namelist_question_unisex.append('住客姓名？')
