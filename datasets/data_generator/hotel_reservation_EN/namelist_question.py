...
namelist_question_female.append('what is the name of the guest , miss ?')
namelist_question_female.append('guest name , miss ?')
...
namelist_question_female.append('miss , guest name , please .')
...
namelist_question_male.append('what is the name of the guest , sir ?')
namelist_question_male.append('guest name , sir ?')
...
namelist_question_male.append('sir , guest name , please .')
...
namelist_question_unisex.append('what is the name of the guest ?')
namelist_question_unisex.append('guest name ?')
...
namelist_question_unisex.append('guest name , please .')
