...
idnumberlist_question_female.append('please tell me the guest\'s passport number , miss .')
idnumberlist_question_female.append('miss , the guest\'s passport number is ?')
...
idnumberlist_question_male.append('please tell me the guest\'s passport number , sir .')
idnumberlist_question_male.append('sir , the guest\'s passport number is ?')
...
idnumberlist_question_unisex.append('please tell me the guest\'s passport number .')
idnumberlist_question_unisex.append('the guest\'s passport number is ?')
