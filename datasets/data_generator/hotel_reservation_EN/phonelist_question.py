...
phonelist_question_female.append('please tell me the guest\'s phone number , miss .')
phonelist_question_female.append('miss , the guest\'s phone number is ?')
...
phonelist_question_male.append('please tell me the guest\'s phone number , sir .')
phonelist_question_male.append('sir , the guest\'s phone number is ?')
...
phonelist_question_unisex.append('please tell me the guest\'s phone number .')
phonelist_question_unisex.append('the guest\'s phone number is ?')
