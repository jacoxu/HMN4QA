...
endinglist_server_female.append('ok miss , the hotel has been reserved for you .')
...
endinglist_server_female.append('done , the hotel has been reserved for you , miss .')

endinglist_server_male = []
endinglist_server_male.append('now you have been booked , sir .')
endinglist_server_male.append('ok sir , the hotel has been reserved for you .')
...
endinglist_server_male.append('done , the hotel has been reserved for you , sir .')

endinglist_server_unisex = []
endinglist_server_unisex.append('now you have been booked .')
endinglist_server_unisex.append('ok , the hotel has been reserved for you .')
...
endinglist_server_unisex.append('done , the hotel has been reserved for you .')
